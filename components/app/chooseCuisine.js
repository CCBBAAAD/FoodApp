...
const ChooseCuisine = ({ navigation }) => {
    ...
    const cuisines = [
        { name: 'Filipino', image: require('../../assets/filipino.png') },
        { name: 'American', image: require('../../assets/american.png') },
        { name: 'Italian', image: require('../../assets/italian.png') },
        { name: 'Dessert', image: require('../../assets/dessert.png') },
        { name: 'Japanese', image: require('../../assets/japanese.png') },
        { name: 'Mexican', image: require('../../assets/mexican.png') },
        { name: 'Korean', image: require('../../assets/japanese1.png') },
        { name: 'Canadian', image: require('../../assets/japanese2.png') },
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.headerProgress}>
                <Text style={[styles.progressText, styles.boldText, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Cuisine</Text>
                <Ionicons name="arrow-forward" size={20} color={fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC'} />
            ...
            <View style={styles.titleBar}>
                <Text style={[styles.subtitle, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Are you in the mood for</Text>
                <Text style={[styles.subtitle, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>_______________________?</Text>
            </View>
            <FlatList
                data={cuisines}
            ...
            />
            {isSelected && <TouchableOpacity style={[styles.addToCartButton, { backgroundColor: bgColor == 'Level 1' ? "#1D601A" : "#298825" }]} onPress={() => { navigation.navigate('ChooseDish'); }} >
