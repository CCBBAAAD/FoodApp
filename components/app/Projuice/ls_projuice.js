...
const LSProjuice = ({ navigation }) => {

    // Add more state for other positions as needed
    const extraSauces = [
        { label: 'Chia Seeds', priceChange: '+₱10.00' },
        { label: 'Turmeric', priceChange: '+₱5.00' },
        { label: 'Mint', priceChange: '+₱10.00' },
        { label: 'Ginger', priceChange: '+₱10.00' },
    ...
    return (
        <View style={{ flex: 1 }}>
            <Image source={require('../../../assets/finalAssets/ls_projuice.png')} style={styles.backgroundImage} />
            ...
            <ScrollView style={styles.detailsContainer}>
                <View style={styles.header}>
                    {cdl == 'Level 1' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Watermelon, Apple, and Carrot Juice</Text>}
                    {cdl == 'Level 2' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Watermelon, Apple, and Carrot Pressed Juice</Text>}
                    {cdl == 'Level 3' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>16 oz Watermelon, Apple, and Carrot Pressed Juice</Text>}
            ...
            <View style={styles.addTocart}>
                ...
                <TouchableOpacity style={[styles.addToCartButton, { paddingHorizontal: ies == 'Level 1' ? 45 : 'Level 2' ? 48 : 52, backgroundColor: bgColor == 'Level 1' ? "#1D601A" : "#298825" }]} onPress={() => { addToCard(cdl == 'Level 1' ? "Watermelon, Apple, and Carrot Juice" : 'Level 2' ? "Watermelon, Apple, and Carrot Pressed Juice" : "16 oz Watermelon, Apple, and Carrot Pressed Juice", 255, "../../assets/finalAssets/ls_projuice.png", quantity) }} >
