...
const TunaSubway = ({ navigation }) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <Image source={require('../../../assets/finalAssets/tuna_subway.png')} style={styles.backgroundImage} />
            ...
            <ScrollView style={styles.detailsContainer}>
                <View style={styles.header}>
                    {cdl == 'Level 1' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Tuna Sandwich</Text>}
                    {cdl == 'Level 2' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>6” Tuna Sandwich</Text>}
                    {cdl == 'Level 3' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>6 inch Tuna Sandwich</Text>}
                    <Text style={[styles.restaurantPrice, { color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>₱230</Text>
                </View>
            ...
            <View style={styles.addTocart}>
                ...
                <TouchableOpacity style={[styles.addToCartButton, { paddingHorizontal: ies == 'Level 1' ? 45 : 'Level 2' ? 48 : 52, backgroundColor: bgColor == 'Level 1' ? "#1D601A" : "#298825" }]} onPress={() => { addToCard(cdl == 'Level 1' ? "Tuna Sandwich" : 'Level 2' ? "6” Tuna Sandwich" : "6 inch Tuna Sandwich", 230, "../../assets/finalAssets/tuna_subway.png", quantity) }} >
