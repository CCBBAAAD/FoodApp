        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={styles.detailsContainer}>
                <View style={styles.header}>
                    {cdl == 'Level 1' && <Text style={[styles.restaurantName, { fontSize: 20, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Pad Thai with Chicken</Text>}
                    {cdl == 'Level 2' && <Text style={[styles.restaurantName, { fontSize: 20, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Authentic or Signature Chicken Pad Thai</Text>}
                    {cdl == 'Level 3' && <Text style={[styles.restaurantName, { fontSize: 20, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Authentic or Signature Chicken Pad Thai with special sauce</Text>}
                ...
                <View style={styles.nutrionalContainer}>
                    ...
                    <View style={styles.nutrionalInfoContainer}>
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>430</Text>
                            <Text style={[styles.nutrionalLabel, { fontSize: fSize == 'Level 1' ? 14 : fSize == 'Level 2' ? 16 : 18 }]}>calories</Text>
                        </View>
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>20g</Text>
                            <Text style={[styles.nutrionalLabel, { fontSize: fSize == 'Level 1' ? 14 : fSize == 'Level 2' ? 16 : 18 }]}>Carbs</Text>
                        </View>
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>71g</Text>
                            <Text style={[styles.nutrionalLabel, { fontSize: fSize == 'Level 1' ? 14 : fSize == 'Level 2' ? 16 : 18 }]}>Fiber</Text>
                        </View>
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>3g</Text>
                ...
                <View style={styles.selectiorContainer}>
                    <Text style={[styles.selectorTitle, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Choice of Sauce (choose 1)</Text>
                ...
                <View style={styles.selectiorContainer}>
                    <Text style={[styles.selectorTitle, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Chili Flakes options (choose 1)</Text>
                ...
                <View style={styles.selectiorContainer}>
                    <Text style={[styles.selectorTitle, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Add ons: Pad Thai (optional)</Text>
