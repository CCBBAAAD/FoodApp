...
const CPTThaiMango = ({ navigation }) => {

    // Add more state for other positions as needed
    const extraSauces = [
        { label: 'Authentic', priceChange: '' },
        { label: 'Signature', priceChange: '' },
    ];

    const extraSauces1 = [
        { label: 'With Chili Flakes', priceChange: '' },
        { label: 'Without Chili Flakes', priceChange: '' },
    ];

    const extraSauces2 = [
        { label: 'Bean Sprout', priceChange: '+₱20.00' },
        { label: 'Chicken Breast (5 cubes)', priceChange: '+₱40.00' },
    ...
    const [toggleOptions1, setToggleOptions1] = useState({});
    ...
    const selectedOption1 = (optionLabel) => {


        setToggleOptions1(optionLabel);
    };
    ...
    return (
        <View style={{ flex: 1 }}>
            <Image source={require('../../../assets/finalAssets/cpt_thaiMango.png')} style={styles.backgroundImage} />
            ...
            <ScrollView style={styles.detailsContainer}>
                <View style={styles.header}>
                    {cdl == 'Level 1' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Pad Thai with Chicken</Text>}
                    {cdl == 'Level 2' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Authentic or Signature Chicken Pad Thai</Text>}
                    {cdl == 'Level 3' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Authentic or Signature Chicken Pad Thai with special sauce</Text>}
                    <Text style={[styles.restaurantPrice, { color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>₱209</Text>
                </View>
                ...
                <View style={styles.nutrionalContainer}>
                    ...
                    <View style={styles.nutrionalInfoContainer}>
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>430</Text>
                        ...
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>20g</Text>
                        ...
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>71g</Text>
                        ...
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>3g</Text>
                ...
                <View style={styles.selectiorContainer}>
                    <Text style={[styles.selectorTitle, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Choice of Sauce (choose 1)</Text>
                    {extraSauces.map((option, index) => (
                        <View key={index}>
                            <TouchableOpacity

                                style={styles.selectorOption}
                                onPress={() => selectedOption1(option.label)}
                            >
                                <CheckBox
                                    checked={toggleOptions1 === option.label}
                                    onPress={() => selectedOption1(option.label)}
                ...
                <View style={styles.selectiorContainer}>
                    <Text style={[styles.selectorTitle, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Chili Flakes options (choose 1)</Text>
                    {extraSauces1.map((option, index) => (
                        <View key={index}>
                            <TouchableOpacity
                ...
                <View style={styles.selectiorContainer}>
                    <Text style={[styles.selectorTitle, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Add ons: Pad Thai (optional)</Text>
                    {extraSauces2.map((option, index) => (
                        <View key={index}>
                            <TouchableOpacity
            ...
            <View style={styles.addTocart}>
                ...
                <TouchableOpacity style={[styles.addToCartButton, { paddingHorizontal: ies == 'Level 1' ? 45 : 'Level 2' ? 48 : 52, backgroundColor: bgColor == 'Level 1' ? "#1D601A" : "#298825" }]} onPress={() => { addToCard(cdl == 'Level 1' ? "Pad Thai with Chicken" : 'Level 2' ? "Authentic or Signature Chicken Pad Thai" : "Authentic or Signature Chicken Pad Thai with special sauce", 209, "../../assets/finalAssets/cpt_thaiMango.png", quantity) }} >
