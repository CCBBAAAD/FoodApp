        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={styles.detailsContainer}>
                <View style={styles.header}>
                    {cdl == 'Level 1' && <Text style={[styles.restaurantName, { fontSize: 20, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Pad Thai with Shrimp</Text>}
                    {cdl == 'Level 2' && <Text style={[styles.restaurantName, { fontSize: 20, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Stir Fry Shrimp Pad Thai</Text>}
                    {cdl == 'Level 3' && <Text style={[styles.restaurantName, { fontSize: 20, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Stir Fry Shrimp Pad Thai in special Pad Thai sauce</Text>}
            ...
            <View style={styles.addTocart}>
                ...
                <TouchableOpacity style={[styles.addToCartButton, { paddingHorizontal: 40, backgroundColor: bgColor == 'Level 1' ? "#1D601A" : "#298825" }]} onPress={() => { addToCard(cdl == 'Level 1' ? "Pad Thai with Shrimp" : 'Level 2' ? "Stir Fry Shrimp Pad Thai" : "Stir Fry Shrimp Pad Thai in special Pad Thai sauce", 289, "../../assets/finalAssets/spt_thaiMango.png", quantity) }} >
