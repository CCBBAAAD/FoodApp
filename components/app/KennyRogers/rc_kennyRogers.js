...
const RcKennyRogers = ({ navigation }) => {
    ...
    const extraParts = [
        { label: 'Chicken Breast', priceChange: ' ' },
        { label: 'Chicken Leg', priceChange: ' ' },
    ...
    return (
        <View style={{ flex: 1 }}>
            <Image source={require('../../../assets/finalAssets/rc_kennyRogers.png')} style={styles.backgroundImage} />
            ...
            <ScrollView style={styles.detailsContainer}>
                <View style={styles.header}>
                    {cdl == 'Level 1' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Roasted Chicken with Side Dish, Rice, and Muffin</Text>}
                    {cdl == 'Level 2' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Classic Roasted Chicken with 1 Side Dish, Rice, and Muffin</Text>}
                    {cdl == 'Level 3' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>1/4 Classic Roasted Chicken with 1 Regular Side Dish, 1 Cup of Rice,
                        and 1 Muffin
                    </Text>}
                ...
                <View style={styles.selectiorContainer}>
                    <Text style={[styles.selectorTitle, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Choice of Chicken Part</Text>
            ...
            <View style={styles.addTocart}>
                ...
                <TouchableOpacity style={[styles.addToCartButton, { paddingHorizontal: ies == 'Level 1' ? 45 : 'Level 2' ? 48 : 52, backgroundColor: bgColor == 'Level 1' ? "#1D601A" : "#298825" }]} onPress={() => { addToCard(cdl == 'Level 1' ? "Roasted Chicken with Side Dish, Rice, and Muffin" : 'Level 2' ? "Classic Roasted Chicken with 1 Side Dish, Rice, and Muffin" : "1/4 Classic Roasted Chicken with 1 Regular Side Dish, 1 Cup of Rice,and 1 Muffin", 250, "../../assets/finalAssets/rc_kennyRogers.png", quantity) }} >
