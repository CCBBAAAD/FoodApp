        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={styles.detailsContainer}>
                <View style={styles.header}>
                    {cdl == 'Level 1' && <Text style={[styles.restaurantName, { fontSize: 18, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Breaded Fish Fillet Sandwich</Text>}
                    {cdl == 'Level 2' && <Text style={[styles.restaurantName, { fontSize: 18, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Crispy Air-Fried Breaded Fish Fillet Sandwich</Text>}
                    {cdl == 'Level 3' && <Text style={[styles.restaurantName, { fontSize: 18, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Crispy Air-Fried Breaded Fish Fillet with Dill Tartar, Lettuce, and TomatoSandwich</Text>}
                ...
                <View style={styles.nutrionalContainer}>
                    ...
                    <View style={styles.nutrionalInfoContainer}>
                        ...
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>14g</Text>
                            <Text style={[styles.nutrionalLabel, { fontSize: fSize == 'Level 1' ? 14 : fSize == 'Level 2' ? 16 : 18 }]}>Carbs</Text>
                        </View>
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>51g</Text>
                            <Text style={[styles.nutrionalLabel, { fontSize: fSize == 'Level 1' ? 14 : fSize == 'Level 2' ? 16 : 18 }]}>Fiber</Text>
                        </View>
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>4g</Text>
