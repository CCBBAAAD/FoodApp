...
const FsKennyRogers = ({ navigation }) => {

    // Add more state for other positions as needed
    // Add more state for other positions as needed
    const extraSauces = [
        { label: 'Corn Muffin', priceChange: '+₱20.00' },
        { label: 'Chicken Noodle Soup', priceChange: '+₱80.00' },
        { label: 'Chicken Macaroni', priceChange: '+₱80.00' },
        { label: 'Sprite in Can', priceChange: '+₱80.00' },
        { label: 'Caesar Salad', priceChange: '+₱180.00' },
    ];
    ...
    return (
        <View style={{ flex: 1 }}>
            <Image source={require('../../../assets/finalAssets/fs_kenyRogers.png')} style={styles.backgroundImage} />
            ...
            <ScrollView style={styles.detailsContainer}>
                <View style={styles.header}>
                    {cdl == 'Level 1' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Breaded Fish Fillet Sandwich</Text>}
                    {cdl == 'Level 2' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Crispy Air-Fried Breaded Fish Fillet Sandwich</Text>}
                    {cdl == 'Level 3' && <Text style={[styles.restaurantName, { fontSize: 18, fontFamily: fStyle == 'Level 1' ? 'Poppins_700Bold' : 'Roboto_700Bold', color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>Crispy Air-Fried Breaded Fish Fillet with Dill Tartar, Lettuce, and TomatoSandwich</Text>}
                    <Text style={[styles.restaurantPrice, { color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>₱260</Text>
                </View>
                ...
                <View style={styles.nutrionalContainer}>
                    ...
                    <View style={styles.nutrionalInfoContainer}>
                        ...
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>14g</Text>
                        ...
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>51g</Text>
                        ...
                        <View style={styles.nutrionalInfoItem}>
                            <Text style={[styles.nutrionalValue, { fontFamily: fStyle == 'Level 1' ? 'Poppins_400Regular' : 'Roboto_400Regular', fontSize: fSize == 'Level 1' ? 12 : 14, color: fColor == 'Level 1' ? '#AD0202' : fColor == 'Level 2' ? 'black' : '#0000CC' }]}>4g</Text>
