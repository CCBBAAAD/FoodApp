...
const CartPageScreen1 = ({ navigation }) => {
    ...
    const [address, setAddress] = useState('Enter your delivery address'); // Set the fullName from the passed param or default to empty
    ...
    const fetchData = async () => {
        ...
        setTimeout(async () => {
            try {
                ...
                if (!methodString) {
                    console.log("no save paymentMethod");
                } else {
